	...
	<div id="header-topbar-option-demo" class="page-header-topbar">
		<nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" class="navbar navbar-default navbar-static-top">
			...
			<div class="navbar-header">
				...
				<button type="button" data-toggle="collapse" id="accordion"	data-target=".sidebar-collapse" class="navbar-toggle">
			...
			<div class="topbar-main">
				...
				<a class="bg-success" id="openInfo" ><i class="fa fa-user"></i>HASTA ÝÞLEMLERÝ</a>
				<a id="openPassword" href="#dialogSifremiDegistir">
				<i class="fa fa-key">
					</i>Sifremi Deðiþtir</a>
				...
				<ul class="bg-info nav navbar navbar-top-links navbar-right mbn">
