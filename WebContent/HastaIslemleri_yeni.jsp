					...
					<div class="panel-heading">
						...
						<div class="row">
							...
							<div class="col-lg-7" >
								...
								(${lastHasta.tel}) &nbsp;&nbsp; Protokol No :
								${lastHasta.protokolNo}</div>
								...
								<c:if test="${silAktif ne '0' }">
									<c:if test="${sessionScope.sessionMember[0].kuTur ne '3' }">
										...
										<button type="button" class="btn btn-link btn-xs "
											data-toggle="modal" data-target="#hastaGuncelleModal"
											data-whatever="${lastHasta.id}">Güncelle</button>
										<button type="button" class="btn btn-link btn-xs"
											data-toggle="modal" data-target="#operasyonEkleModal"
											data-whatever="${lastHasta.id}">Tedavi Ekle</button>
										<button type="button" class="btn btn-link btn-xs"
											data-toggle="modal" data-target="#anketEkleModal"
											data-whatever="${lastHasta.id}">Anket Ekle</button>
										<button type="button" class="btn btn-link btn-xs "
											style="color: red;" data-toggle="modal"
											data-target="#hastasSilModal"
											data-whatever="${lastHasta.id}">Sil</button>
									</c:if>
							...
							<div id="tab-general">
								<div class="row mbl">
									<ul id="generalTab" class="nav nav-tabs responsive">
										...
										<li >
										<a href="#tedavi-tab" data-toggle="tab">Oral</a>
										</li>
										<li><a href="#anket-tab" data-toggle="tab">Anket</a>
										</li>
									...
									<div id="generalTabContent" class="tab-content responsive">
										...
										<div id="hasta-info-tab" class="tab-pane fade in active">
											<jsp:include page="HastaKarti.jsp"></jsp:include>
										</div>

										<div id="tedavi-tab" class="tab-pane">
										
											<div style="font-size: 11px;">

												<c:forEach items="${lastHasta.hastaOperasyonList}"
													...
													<div class="panel">
														...
														<div class="panel-heading"
															...
															<div class="row">
																<div>
																	...
																	&nbsp; &nbsp; &nbsp; Tarih:${operasyon.islemTarihi}
																	&nbsp; &nbsp; &nbsp; Fiyat: ${operasyon.miktar} &nbsp;
																	&nbsp; &nbsp;
														...
														<div class="collapse" id="${operasyon.id}">
															<div class="panel-body ">
																...
																<div class="col-lg-5 col-md-5">
																	...
																	<div>
																		...
																		${operasyon.islemTarihi} ${operasyon.islemBitisTarihi}

																	</div>

																	<div>
																		<strong>Diþ Sayýsý : </strong> ${operasyon.disAdet}
																	</div>

																	<div>
																		<strong>Diþ No'lar : </strong> ${operasyon.disNo}
																	</div>
																	...
																	<div>
																		<strong> Tedavi Fiyat : </strong> ${operasyon.miktar}
																	</div>
																	<div>
																		<strong> Kalan Ödeme Miktarý : </strong>
																		${operasyon.kalanMiktar}
																	</div>
																	<div>
																		<strong> Açýklama : </strong> ${operasyon.aciklama}
																	</div>
																	...
																	<c:if test="${!empty operasyon.odemeList}">
																		<table class="table table-hover table-bordered">
																			...
																			<tbody>
																				...
																				<c:forEach items="${operasyon.odemeList}"
															...
															<div class="panel-footer">
																...
																<button type="button"
																	class="btn btn-link btn-sm randevuEkleButton"
...
-->
																...
																<c:if test="${silAktif ne '0' }">
																	<c:if
																		...
																		<button type="button" class="btn btn-link btn-sm"
																			data-toggle="modal"
																			data-target="#operasyonGuncelleModal"
																		...
																		<c:if test="${operasyon.kalanMiktar >0}">
																			<button type="button" class="btn btn-link btn-sm"
																				...
																				data-hastaid="${lastHasta.id}">Ödeme
																				Ekle</button>
																		</c:if>
																		...
																		<c:if test="${operasyon.durumu eq 'A'}">
																			<button type="button" class="btn btn-link btn-sm"
																				data-toggle="modal"
																				data-target="#operasyonBitirModal"
																				data-opid="${operasyon.id}"
																		...
																		<c:if test="${operasyon.durumu eq 'K'}">
																			...
																			<button type="button" class="btn btn-link btn-sm"
																				data-toggle="modal"
																				data-target="#aramaKaydiEkleModal"
																				data-opid="${operasyon.id}"
																				data-opad="${operasyon.islemTip.ad}">Arama
																				Kaydý Ekle</button>
																		</c:if>
										...
										<div id="anket-tab" class="tab-pane">
											<div class="panel panel-white">
												<div class="panel-heading">
													<div class="row">
														<div class="col-lg-6 col-md-6">${lastHasta.ad}
															${lastHasta.soyad}</div>
													</div>
												</div>
												<div class="panel-body">
				...
				<form action="HastaOperasyonEkle.do" method="post"
					...
					<div class="modal-body">
						...
						<div class="col-lg-6 col-md-6">
							...
							<input type="hidden" name="hastaId" value="${lastHasta.id}">
							...
							<div class="row ">
								...
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										...
										<strong> Tedavi Tarihi : </strong> <input
									...
									<div class="form-group">
										...
										<div class="input-icon">
											...
											<div class="btn-group btn-group-xs">
												<button type="button"
													class="col-lg-12 col-md-12 btn btn-default disno">Üst
													Çene</button>
											...
											<div class="btn-group btn-group-xs">
												...
												<button type="button"
													class="col-lg-12 col-md-12 btn btn-default disno">Alt
													Çene</button>
							...
							<div class="row">
								...
								<div class="col-lg-5 col-md-5">
									<div class="form-group">
										<input class="form-control" placeholder="Adet" name="disAdet"
							...
							<div class="row">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<input class="form-control" placeholder="Kalan Miktar"
											name="kalanMiktar" id="kalanMiktar" readonly="readonly">
								...
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<div class="input-icon">
											...
											<input id="bntKaydetTedavi"
												class="btn btn-default pull-right" type="submit"
												value="Ekle" onclick="return checkTedavi();" />
