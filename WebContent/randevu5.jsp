					...
					<form action="HastaRandevuEkle.do" method="post"
						...
						<div class="modal-body">
									...
									<div class="form-group">
										...
										<div class="input-icon">
											<i class="fa fa-user" aria-hidden="true"></i> <input
												...
												id="hastaad" data-validation="required" readonly="readonly">
							...
							<div class="row">
									...
									<div class="form-group">
										...
										<div class="input-icon">
											<i class="fa fa-phone"></i> <input class="form-control"
												name="telefon" placeholder="Telefon Orn. 05051119922"
												id="telefon" data-validation="required" readonly="readonly">
								...
								<div class="col-lg-3">
									<div class="form-group">
										<label for="inputName" class="control-label">Protokol
											No </label>
										<div class="input-icon">
											<i class="fa fa-pencil" aria-hidden="true"></i> <input
												class="form-control" name="protokol"
												placeholder="Protokol no" id="protokol" readonly="readonly"
												readonly="readonly">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea class="form-control" name="aciklama"
											placeholder="Açýklama Giriniz" rows="2" id="title" cols="40"></textarea>
						...
						<div class="form-group">
							<div class="input-icon" class="bg-info">
								...
								Telefon : <span id="hastaTel"></span> <br> Protokol No :<span
									...
									id="tedavi"></span> <br> Diþ No :<span id="tedaviDisNo"></span>
