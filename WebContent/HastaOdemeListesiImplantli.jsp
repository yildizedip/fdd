...
<table align="center">
	<tr>
		...
		<table class="sorgulama">
				...
				<tr>
					<td>İşlem Tipi</td>
					<td colspan="2"><input class="inputTextfield" name="protokolNo" style="width: 229px; background-color: buttonshadow;" readonly="readonly" id="hastaAd" value="${hastaOperasyonListesi['0'].islemTip.ad }"></td>
				...
				<c:if test="${hastaOperasyonListesi['0'].islemTipi eq '24' }">
				<tr>
					<td>Doktor Cerrahi</td>
					<td><input class="inputTextfield" style="width: 416px; 
					background-color: buttonshadow;" name="hastaAd" readonly="readonly" id="hastaAd" value="${hastaOperasyonListesi['0'].implantDoktor.dAd} - ${hastaOperasyonListesi['0'].implantDoktor.dSoyad }"></td>
				</tr>				
				
				<tr>
					<td>İmplant Ücreti</td>
					<td>
					<input class="inputTextfield" style="width: 150px; background-color: buttonshadow;" name="implantUcret" id="implantUcret" value="${hastaOperasyonListesi['0'].implantUcret}"> TL</td>
				</tr>

				<tr>
					<td>İmplant Üstü Protez Ücreti</td>
					<td>					
					<input class="inputTextfield" style="background-color: buttonshadow;" name="implantProtezUcret" value="${hastaOperasyonListesi['0'].implantProtezUcret}" id="implantProtezUcret"> TL</td>
				</tr>
				</c:if>
				<tr>
					<td>Açıklama</td>
		...
		<hr>
		<table class="sofT" >
		<tr> <td class="helpHed"  colspan="7"> ÖDEME LİSTESİ</td> </tr>	
		<tr>
			<td class="helpHed" ></td>
