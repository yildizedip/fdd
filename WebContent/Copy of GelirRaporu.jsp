	...
	<tr>
		...
		<table class="sorgulama">
			...
			<tr>
				...
				<c:if test="${sessionScope.sessionMember[0].kuTur ne '3' && sessionScope.sessionMember[0].kuTur ne '4'  }">
				
				<tr> <td>Doktor</td> <td colspan="3">  <select size="1" name="doktorId" class="giderTuru">
