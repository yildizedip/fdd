	...
	<div>
		...
		<nav class="navbar navbar ">
					...
					<c:choose>
						<c:when test="${menu.ustMenuId eq 0 }">
							...
							<c:if test="${menu.subMenu[0] eq null}">
								...
								<li class="active"><a href="${menu.menuPage}"
									target="frame"> ${menu.menuAd} </a></li>
							...
							<c:if test="${menu.subMenu[0] ne null}">
								...
								<li class="dropdown"><a class="dropdown-toggle"
									data-toggle="dropdown" href="#">${menu.menuAd} <span
										class="caret"></span></a>
									...
									<ul class="dropdown-menu">
										...
										<c:forEach items="${menu.subMenu}" var="subMenu">
											...
											<li><a href="${subMenu.menuPage}" target="frame">
													${subMenu.menuAd} </a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="cikis.jsp"> <i class="fa fa-sign-out"
						aria-hidden="true"></i>
				</a></li>
				...
				<div class="modal-content">
					...
					<form action="KullaniciGuncelle.do?tip=kisiselBilgileriGuncelle"
						...
						<div class="modal-body">
							...
							<div>
								<label> Ad...........:</label> <input class="inputTextfield"
							...
							<div>
								<label> Soyad......:</label> <input class="inputTextfield"
									name="soyad" value="${sessionScope.sessionMember[1].kuSoyad}">
							</div>
							<div>
