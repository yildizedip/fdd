	...
	<div class="row">
		...
		<div class="col-lg-5" id="hastaPanel" hidden="true">
				...
				<div class="portlet-header">
					...
					<h4 class="box-heading">${hastaListesi[0].ad} ${hastaListesi[0].soyad} - ${hastaListesi[0].tel}</h4>
					
													<c:if test="${silAktif ne '0' }">
														<c:if test="${sessionScope.sessionMember[0].kuTur ne '3' }">
					
																	<button type="button" data-toggle="modal" data-target="#hastaGuncelleModal" data-whatever="${hastaListesi[0].id}">Güncelle</button>
																	<button type="button" data-toggle="modal" data-target="#operasyonEkleModal"	 data-whatever="${hastaListesi[0].id}">Tedavi Ekle</button>
																	<button type="button" data-toggle="modal" data-target="#anketEkleModal"	 data-whatever="${hastaListesi[0].id}">Anket Ekle</button>
																	<button type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#hastasSilModal"	data-whatever="${hastaListesi[0].id}">Sil</button>
														</c:if>
		...
		<div class="col-lg-7">
			...
			&nbsp;
			 ...
			 <button type="button" class="btn btn-primary" data-toggle="modal"
			data-target="#hastaSecModal"   >Hasta Seç.</button>
		...
		<div class="page-content">
					...
					<div id="tab-general">
                        <div class="row mbl">
	                            ...
	                            <li class="active" >  <a href="#tedavi-tab" data-toggle="tab">Tedavi Ve Ödemeler</a></li>
	                            <li><a href="#anket-tab" data-toggle="tab">Anket</a></li>
	                            <li><a href="#hasta-info-tab" data-toggle="tab">Hasta Bilgileri</a></li>
		                        </ul>
								               	...
								               	<c:forEach items="${hastaListesi[0].hastaOperasyonList}"
														var="operasyon" varStatus="count">
																...
																<div class="panel panel-white">
																	<div class="panel-heading" style="color: black; font-size: 16px">
																		<div class="row">
																			<div> 
																			Tedavi: ${operasyon.islemTip.ad}	&nbsp;	&nbsp;	&nbsp;  
																			Hekim: ${operasyon.doktor.dAd} ${operasyon.doktor.dSoyad} 	&nbsp;	&nbsp;	&nbsp;
																			Durum :
...
<button type="button" class="btn btn-success randevuEkleButton" id="randevuEkle" value="${operasyon.doktorId}" data-opId="${operasyon.id}"> Randevu Ekle</button>
<!--  
...
<button type="button" class="btn btn-success"	data-toggle="modal" data-target="#aramaKaydiEkleModal"	data-opid="${operasyon.id}" data-opad="${operasyon.islemTip.ad}" > Arama Kaydý Ekle</button>
</c:if>																	
...
<button type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#operasyonSilModal" data-opid="${operasyon.id}"  data-opad="${operasyon.islemTip.ad}">Sil</button>
		                        								...
		                        								<div class="panel panel-white">
																	...
																	<table class="table table-hover table-bordered">
																				...
																				<tbody>
																					...
																					<c:forEach items="${hastaListesi[0].hastaAnketList}" var="anket" varStatus="count">
												...
												<div class="panel panel-white">
													...
													<div class="panel-body">
														...
														<div class="col-lg-6">
														 ...
														 <p>Hasta Ad :${hastaListesi[0].ad}	${hastaListesi[0].soyad} </p> 
	...
	<form id="randevuEkleForm" action="hastaSorgulaForRandevu.do" method="post">
		<input type="hidden" name="hastaId" id="hasta_id_randevuForm" value="${hastaListesi[0].id}">
		<input type="hidden" name="islem" id="pageAction">
		<input type="hidden" name="doktorId" id="doktorIdForm" >
		<input type="hidden" name="islemId" id="operasyonIdForm" >
	</form>
				...
				<div class="modal-content">
					...
					<form action="hastaEkle.do" method="post" onsubmit="return validateForm()" name="hastaForm" >
						...
						<div class="modal-footer">
							<input id="bntHastaKaydet" type="submit" value="Hasta Ekle" class="btn btn-default" />
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<div class="input-icon">
												<div class="hero-unit">
													<input class="tarih " type="text" name="odemeTarihiStr" id="odemeTarihiStr" 
					...
					<div class="modal-body">
									...
									<table class="table">
										...
										<tr>
											...
											- <input  name="islemBitisTarihiStr" id="islemBitisTarihiStrModal" class="tarih"  />
						...
						<div class="modal-footer">
							<input type="submit"  class="btn btn-default" value="Tedavi Güncelle" id="btn_gonder" name="bnt_gonder"/>
							<button type="button" class="btn btn-default" data-dismiss="modal">Vazgeç</button>
						</div>
	...
	<div id="anketEkleModal" class="modal fade" >
			<div class="modal-dialog" role="document">
				...
				<div class="modal-header">
						...
						<h4 class="modal-title" id="exampleModalLabel"> HASTA MEMNUNÝYET ANKETÝ BÝLGÝLERÝ FORMU <br> ${hastaListesi[0].ad} ${hastaListesi[0].soyad} </h4>
					</div>
					...
					<div class="modal-body">
									...
									<table class="table">
										...
										<tr>
											...
											<input  name="tarihStr" class="tarih" id="anketAramaTArihi" data-validation="required" />
											 <input type="hidden" name="hastaId" value="${hastaListesi[0].id}" id="hastaId">
											</td>
										...
										<tr>
											<td>Saat</td>
											<td><select size="1" name="saat" id="saat" style="width: 86px; font-size:12px " data-validation="required">
											 ...
											 : <select name="dakika" size="1" id="dakika" style="width: 86px; font-size:12px ">
										...
										<tr>
											...
											<td><select size="1" name="memnuniyetDerecesi" id="memnuniyetDerecesi"  data-validation="required">
	...
	<div id="aramaKaydiEkleModal" class="modal fade" >
			<div class="modal-dialog" role="document">
				...
				<div class="modal-header">
						...
						<h4 class="modal-title" id="exampleModalLabel"> HASTA ARAMA KAYDI GÝRÝÞÝ (KESINLEÞMEMÝÞ OPERASYONLAR)  <br> ${hastaListesi[0].ad} ${hastaListesi[0].soyad} </h4>
					</div>
				
			<form action="aramaKaydiEkle.do" method="post" onsubmit="return validation()">
			
			<input type="hidden" name="islemId" id="" >
			 <input type="hidden" name="hastaId" value="${hastaListesi[0].id}" id="hastaId">
					<div class="modal-body">
						<span id="operasyonAd" > </span>
												<table class="table">
													...
													<tr>
														...
														<input class="tarih" name="aramaTarihiStr" 	id="aramaTarihiEkleStr" />
														</td>
													
													<tr>
														<td>Saat</td>
														<td><select size="1" name="saat" id="saat" style="width: 86px; font-size:12px ">
															<option value="-1" label="Saat">
															<c:forEach items="${saatler}" var="saat" >
															<option value="${saat}" label="${saat}" ></option>				
															</c:forEach>
														 ...
														 : <select name="dakika" id="dakika" size="1" style="width: 86px; font-size:12px ">
														<option value="-1" label="Dk">
														<c:forEach items="${dakikalar}" var="dakika">
														<option label="${dakika }" value="${dakika }">
			...
			<div class="modal-dialog" >
				<div class="modal-content">
					...
					<div class="row">
						...
						<div class="modal-footer">
							<input type="submit"  class="btn btn-default" value="Randevu Ekle" id="btn_gonder" name="bnt_gonder"/>
							<button type="button" class="btn btn-default" data-dismiss="modal">Vazgeç</button>
						</div>
	...
	$(document).ready(
			function() {
				...
				$.validate({
					...
					$('#aramaKaydiEkleModal').on('show.bs.modal', function (event) {
						  var button = $(event.relatedTarget) 
						  var opid = button.data('opid')
					...
					$('#randevuEkleModal').on('show.bs.modal', function (event) {
						 $(this).find('.modal-dialog').css({
				              width:'100%', //probably not needed
				              height:'700', //probably not needed 
				      		 });
						  var button = $(event.relatedTarget) // Button that triggered the modal
						  var opid = button.data('opid') // Extract info from data-* attributes
						  var opad = button.data('opad') // Extract info from data-* attributes
					...
					$('.randevuEkleButton').click(function (event) {
				 		...
				 		$('#pageAction').val('randevu-getir-hasta-islemleri');
						$('#doktorIdForm').val(doktorId);
