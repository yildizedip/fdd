					...
					<div class="col-lg-8 panel panel-success">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								    <input type="text" class="form-control tarih" placeholder="Başlangıç Tarihi" name="baslangicTarihi" id="baslangicTarihi">
								  </div>
								  <div class="form-group">
								    <input type="text" class="form-control tarih"  placeholder="Bitiş Tarihi" name="bitisTarihi" id="bitisTarihi">
								  </div>
								  
								  <button type="submit" class="btn btn-default">Randevuları Getir</button>
