				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					...
					<a data-hover="dropdown"
						...
						<span class="caret">
							...
							<li class="divider"></li>
							<li><a href="logout.jsp"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Çýkýþ</a></li>
						</ul>
                    ...
                    <div id="tab-general">
                        <div class="row mbl">
                            <div class="col-lg-12">
                            	...
                            	<iframe src="randevuGunluk.jsp" name="frame" width="100%" height="700" frameborder="0" scrolling="auto"></iframe>
