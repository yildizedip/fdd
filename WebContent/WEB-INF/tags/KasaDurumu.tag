...
<body>
<label class="fonte"> Toplam Kasa Durumu (Tarih:<jsp:doBody/>) </label> 
	<table class="sofT" >	
		<tr>
		<td class="helpHed" ></td>
		...
		<c:forEach items="${sessionScope.gunlukKasaDurumu}" var="gelir" varStatus="count">
		<tr>
...
<br>
<label class="fonte"> Günlük Gelir - Gider Analizi (Tarih:<jsp:doBody/>): </label> 
	<table class="sofT" >	
		<tr>
			<td class="helpHed"></td>
			<td class="helpHed">Odeme Sekli</td>			
