...
<div>
		<hr>
			...
			..: Hasta Memnuniyet Anketi Girmek için lütfen hasta sorgulayınız.
		...
		<tr>
				...
				<th class="helpHed">Anket Sayısı</th>
			...
			<c:forEach items="${hastaListesi}" var="hasta" varStatus="count">
				<tr>
					...
					<td class="helpBod" style="text-align: left;">
						...
						<table align="left"  > 
						<tr> <th>Operasyon</th> <th>Bitiş Tar.</th>   <th> Miktar</th>   <th>Kalan Miktar</th>  </tr>
					...
					<td class="helpBod"> ${hasta.hastaAnketSayisi} </td>
						...
						<c:if test="${sessionScope.sessionMember[0].kuTur eq '4' }">
							...
							<html:link
								href="HastaAnketKaydiGir.jsp?hastaId=${hasta.id}&subeId=${subeId}"> Anket Kaydı Gir </html:link></td>
