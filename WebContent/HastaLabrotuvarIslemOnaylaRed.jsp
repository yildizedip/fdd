			...
			<table class="sorgulama" style="width: 967px;">
				<tr>
					<th colspan="2" style="text-align: center; font-size: 14px">
						LABORATUVAR İŞLEM DEĞERLENDİRME FORMU <BR>
					</th>
				</tr>
				<tr>
					...
					<td align="left" style="width: 554px;"><c:forEach
						...
						<table>
							...
							<tr>
								...
								<input name="klinikDegerlendirmeTar" id="degerlendirmeTar" value="${tarihStr}">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3" style="text-align: left:;"><select
									style="width: 154px;" id="puan" name="labIslemPuan">
										<option value="-1" label="Seçiniz"></option>
										<option value="0" label="Zayıf"></option>
										<option value="50" label="Geçer"></option>
										<option value="75" label="Orta"></option>
										<option value="85" label="İyi">
										<option value="100" label="Mükemmel"></select>
								 </td>
							</tr>
							<tr> 
															...
															<td>İşlem Onay :</td>
							<td colspan="3">
							<select style="width: 154px; " id="islemOnay"
									name="labIslemOnayRed">
							<option value="-1" label="Seçiniz"></option>
							<option value="1" label="Onayla"></option>
							<option value="2" label="RPT"></option>
							</select>
							</td>
							</tr>
							<tr>
