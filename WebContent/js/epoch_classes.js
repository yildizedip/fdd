...
*****************************************************************************/
//constructor for the main Epoch class (TURKISH VERSION)
...
{
	this.daylist = new Array('Pz','Pt','Sa','Çr','Pe','Cu','Ct','Pz','Pt','Sa','Çr','Pe','Cu','Ct');
	this.months_sh = new Array('Oca','Þub','Mar','Nis','May','Haz','Tem','Aðu','Eyl','Eki','Kas','Ara');
	this.monthup_title = 'Sonraki aya git';
	this.monthdn_title = 'Önceki aya git';
	this.clearbtn_caption = 'Temizle';
	this.clearbtn_title = 'Takvimde seçilmiþ tarihleri temizle';
	this.maxrange_caption = 'Bu maksimum dizidir';
};
//-----------------------------------------------------------------------------
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Ocak','Þubat','Mart','Nisan','Mayýs','Haziran','Temmuz','Aðustos','Eylül','Ekim','Kasým','Aralýk','Oca','Þub','Mar','Nis','May','Haz','Tem','Aðu','Eyl','Eki','Kas','Ara');
	var DAY_NAMES = new Array('Pazar','Pazartesi','Salý','Çarþamba','Perþembe','Cuma','Cumartesi','Paz','Pzt','Sal','Çrþ','Prþ','Cum','Cmt');
	format = format + "";
	var result="";
	var i_format=0;
	var c="";
