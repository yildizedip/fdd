...
<body style="color: black;">
	...
	<div class="row col-lg-3 bg-warning"> ${requestScope.warn} </div>
																		...
																		<c:if test="${!empty operasyon.odemeList}">
																			...
																			<c:if test="${operasyon.durumu eq 'K'}">
																						...
																						<table class="sofT" id="example">
																								...
																								<tbody>
																									<c:forEach items="${operasyon.aramaKayitListesi}" var="arama" varStatus="count">
																										<tr>
																											<td >${count.count}</td>
																											<td >${arama.aramaTarih}</td>
																											<td >${arama.aramaSaat}</td>
																											<td >${arama.aciklama}</td>
...
<script type="text/javascript">
	...
	/* 			      $( "#islemTarihiStr" ).datepicker();
						...
						$( "#islemTarihiStrModal" ).datepicker();
						 
						$( "#islemTarihiStrModal" ).datepicker( "option", "dateFormat", "yy.mm.dd" ); 
						 
						$( "#odemeTarihiStr" ).datepicker();
						$( "#odemeTarihiStr" ).datepicker( "option", "dateFormat", "yy.mm.dd" );
						
						
						$( "#odemeTarihiStrModal" ).datepicker();
						$( "#odemeTarihiStrModal" ).datepicker( "option", "dateFormat", "yy.mm.dd" );
						
						
						$( "#odemeTarihiStrOdemeGuncelleModal" ).datepicker();
						$( "#odemeTarihiStrOdemeGuncelleModal" ).datepicker( "option", "dateFormat", "yy.mm.dd" );
						
						$( "#borcOdemeTarihiStr" ).datepicker();
						$( "#borcOdemeTarihiStr" ).datepicker( "option", "dateFormat", "yy.mm.dd" );
						
						$( "#operasyonBitirTrhStr" ).datepicker();
						$( "#operasyonBitirTrhStr" ).datepicker( "option", "dateFormat", "yy.mm.dd" );
						
						$( "#operasyonKesinlestirTrhStr" ).datepicker();
						$( "#operasyonKesinlestirTrhStr" ).datepicker( "option", "dateFormat", "yy.mm.dd" ); */
