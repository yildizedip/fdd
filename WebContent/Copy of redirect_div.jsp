...
<div id="menu"><c:choose>
	<c:when
		...
		<ul>
			...
			<li><html:link action="/hastaSorgula.do" target="frame"> Hasta Güncelle Sil</html:link>
	...
	<c:when test="${sessionScope.sessionMember[0].kuTur eq '1' }">
		...
		<ul>
			...
			<li><html:link action="/hastaBazliToplamOdemeListesi?tip=12"
				target="frame"> Doktor Ekle Güncelle Sil </html:link></li>
			<li><html:link action="/hastaBazliToplamOdemeListesi?tip=13"
...
<div id="alt">Dicle Fırat Diş Polikliği &copy; 2012</div>
