					...
					<div class="form-body pal">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<div class="input-icon">
										<i class="fa fa-user"></i> <input id="tckimlik" onkeyup="kontrol()" name="tckimlik"
							...
							<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="input-icon">
												<div class="checkbox">
													<label> <input type="checkbox" id="implantAktif" />
														&nbsp; Implant
													</label>
												</div>
								...
								<div class="row" id="implantOk" hidden="true">
									<div class="col-lg-12">
										<div class="form-group ">
											<select size="1" name="doktorId" class="form-control">
												<option label="Protez Yapacak Diş Hekimini Seçiniz.."
													value="-1">Hekim Seçiniz</option>
									...
									<div class="col-lg-12">
										<div class="form-group">
												 <input
													...
													name="miktar" id="miktar" onkeyup="hesapla()">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="input-icon">
												<div class="checkbox">
													<label> <input type="checkbox" id="durumu" name="durumu" />
														&nbsp; Kesinleşmedi
													</label>
												</div>
										...
										<div class="form-group">
											<div class="input-icon">
												<textarea class="form-control" name="aciklama"
													placeholder="Açıklama Giriniz" rows="4" name="aciklama"
									...
									<div class="col-lg-12">
										<div class="form-group">
											<div class="input-icon">
												<div class="hero-unit">
												<i class="fa fa-calendar"></i>
													<input class="form-control ornek " type="text" name="odemeTarihiStr"
							id="odemeTarihiStr" 
